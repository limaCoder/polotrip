...
const getUserAlbumsSchema = z.object({
  limit: z
    .number()
    .optional()
    .default(10)
...
const getTripStatsSchema = z.object({
  albumId: z.string().describe("The ID of the album"),
});

const getPhotosByDateSchema = z.object({
  albumId: z.string().describe("The ID of the album"),
  date: z
    .string()
...
const getPhotosByLocationSchema = z.object({
  albumId: z.string().describe("The ID of the album"),
  location: z
    .string()
...
const getAlbumByNameSchema = z.object({
    ...
    const result = streamText({
      ...
      tools: {
        getUserAlbums: tool({
          ...
          inputSchema: getUserAlbumsSchema,
          execute: async ({ limit }) => {
        ...
        getAlbumPhotos: tool({
          ...
          inputSchema: getAlbumPhotosSchema,
        ...
        getTripStats: tool({
          ...
          inputSchema: getTripStatsSchema,
        ...
        getPhotosByDate: tool({
          ...
          inputSchema: getPhotosByDateSchema,
        ...
        getPhotosByLocation: tool({
          ...
          inputSchema: getPhotosByLocationSchema,
        ...
        getAlbumByName: tool({
          ...
          inputSchema: getAlbumByNameSchema,
          execute: async ({ query }) => {
