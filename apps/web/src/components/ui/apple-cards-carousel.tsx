  ...
  return (
    <>
      <motion.div
        ...
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 h-[549px] w-[340px] md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
